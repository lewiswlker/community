...
import com.hust.community.entity.*;
...
public class DiscussPostController implements CommunityConstant {
    ...
    public String addDiscussPost(String title, String content) {
        ...
        if (user == null) {
            return CommunityUtil.getJSONString(403, "您还未登录，请先登录后发帖。");
        }
    ...
    public String setTop(int id) {
        User user = hostHolder.getUser();
        discussPostService.updateType(id, DISCUSSPOST_STATUS_TOP);
    ...
    public String setWonderful(int id) {
        User user = hostHolder.getUser();
        discussPostService.updateStatus(id, DISCUSSPOST_STATUS_WONDERFUL);
    ...
    public String setDelete(int id) {
        User user = hostHolder.getUser();
        discussPostService.updateStatus(id, DISCUSSPOST_STATUS_DELETE);
